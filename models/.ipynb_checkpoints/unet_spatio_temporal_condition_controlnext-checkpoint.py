...
class UNetSpatioTemporalConditionControlNeXtModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    r"""
    ...
    def forward(
        ...
        for idx,downsample_block in enumerate(self.down_blocks):
            ...
            if idx == 0 and conditional_controls is not None:
                ...
                sample = sample + conditional_controls * scale * control_scale
