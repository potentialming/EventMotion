...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        frames_per_batch: int = 14,
        controlnext_cond_scale: float = 1.0,
        overlap: int=4,
    ):
        r"""
        ...
        image = self.video_processor.preprocess(image, height=height, width=width).to( device=device,dtype=image_embeddings.dtype)
